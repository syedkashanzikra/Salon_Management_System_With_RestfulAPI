        ...
        <div class="card mb-4">
            <div class="card-body p-3 d-flex align-items-center">
                <div class="bg-primary text-white p-3 me-3">
                    <svg class="icon icon-xl">
                        <use xlink:href="{{asset('/fonts/free.svg#cil-settings')}}"></use>
                    </svg>
                </div>
                <div>
            ...
            <div class="card-footer px-3 py-2">
                <a class="btn-block text-medium-emphasis d-flex justify-content-between align-items-center" href="#"><span class="small fw-semibold">View More</span>
                    <svg class="icon">
                        <use xlink:href="{{asset('/fonts/free.svg#cil-chevron-right')}}"></use>
                    </svg>
                </a>
            </div>
        </div>
        ...
        <div class="card mb-4">
            <div class="card-body p-3 d-flex align-items-center">
                <div class="bg-info text-white p-3 me-3">
                    <svg class="icon icon-xl">
                        <use xlink:href="{{asset('/fonts/free.svg#cil-laptop')}}"></use>
                    </svg>
                </div>
                <div>
        ...
        <div class="card mb-4">
            <div class="card-body p-3 d-flex align-items-center">
                <div class="bg-warning text-white p-3 me-3">
                    <svg class="icon icon-xl">
                        <use xlink:href="{{asset('/fonts/free.svg#cil-moon')}}"></use>
                    </svg>
                </div>
                <div>
        ...
        <div class="card mb-4">
            <div class="card-body p-3 d-flex align-items-center">
                <div class="bg-danger text-white p-3 me-3">
                    <svg class="icon icon-xl">
                        <use xlink:href="{{asset('/fonts/free.svg#cil-bell')}}"></use>
                    </svg>
                </div>
                <div>
