...
class TipServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    protected $moduleName = 'Tip';

    /**
     * @var string
     */
    protected $moduleNameLower = 'tip';
    ...
    public function boot()
    {
        ...
        $this->registerConfig();
        $this->registerViews();
        $this->loadMigrationsFrom(base_path('Modules/Tip/database/migrations'));

        // adding global middleware
        $kernel = $this->app->make('Illuminate\Contracts\Http\Kernel');

        // register commands
        $this->registerCommands('\Modules\Tip\Console\Commands');
    }
