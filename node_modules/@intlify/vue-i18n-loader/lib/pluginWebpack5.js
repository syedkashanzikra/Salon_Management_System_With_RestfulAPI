...
class VueComponentDependency extends Dependency {
    static Template;
    script; /* webpack.Dependency */
    template; /* webpack.Dependency */
    values;
    statement;
...
function toCode(code) {
    ...
    if ((0, shared_1.isRegExp)(code) && code.toString) {
        return code.toString();
    }
    if ((0, shared_1.isFunction)(code) && code.toString) {
        return '(' + code.toString() + ')';
    }
    if ((0, shared_1.isObject)(code)) {
...
function getScriptBlockModule(parser /* webpack.javascript.JavascriptParser */) {
    return parser.state.current.dependencies.find((dep) => {
        ...
        if (req && dep.originModule) {
            const query = (0, querystring_1.parse)(req);
