...
if (! function_exists('config_path')) {
    ...
    function config_path($path = '')
    {
        try {
            ...
            // If a path is provided, append it to the configuration path
            return $path ? $configPath . DIRECTORY_SEPARATOR . $path : $configPath;
        } catch (\Exception $e) {
            // Handle the exception gracefully and return an empty string
            return '';
        }
    }
